...
do_windows (){
 ...
 for i in __init__.py x11_hash.pyd groestlcoin_hash.pyd ltc_scrypt.pyd  neoscrypt.pyd  qubit_hash.pyd skeinhash.pyd ; do
...
#test -d python-trezor || git clone https://github.com/Oracoinofficial/python-trezor
...
# Build docker images
$DOCKERBIN images|awk '{print $1":"$2}'|grep "oracoin/electrum-oracoin-winbuild:${VERSION}" || buildImage winbuild
$DOCKERBIN images|awk '{print $1":"$2}'|grep "oracoin/electrum-oracoin-release:${VERSION}" || buildImage release
