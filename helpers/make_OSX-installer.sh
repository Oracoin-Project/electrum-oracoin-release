...
cp -av ${BUILD_REPO}/icons/electrum-oracoin-logo.jpg Resources/en.lproj/background



#pkgbuild --analyze --root ${INSTALL_ROOT} 'Electrum-Oracoin.plist'
...
#echo "sed"
sed -e '$ i\
 \    <title>Electrum-Oracoin '${VERSION}'</title>' \
 -e '$ i\
