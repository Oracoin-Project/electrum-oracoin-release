...
all(){
 ...
 rm -rf source/Electrum Oracoin Wallet*
 rm -rf source/electrum-oracoin-setup.exe
 rm -rf ltc_scrypt*
 ...
 rm -rf x11_hash-master.tar.gz*
 rm -rf x11_hash*
 rm -rf groestlcoin*
 rm -rf SocksiPy*
 rm -rf helpers/.??*
 rm -rf helpers/repo
 rm -rf helpers/electrum-oracoin-release
 rm -rf src/Electrum Oracoin Wallet-*.dmg 
 rm -rf Makefile
...
case $CLEAN in 
    osx) echo "Cleaning for build_osx.sh"
         rm -rf src/Electrum Oracoin Wallet.app
